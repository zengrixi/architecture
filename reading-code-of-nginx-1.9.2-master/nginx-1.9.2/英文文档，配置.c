...
Survey: The Future of Application Development & Deployment
We are interested in your ideas about the future of app development and delivery.
...
$secure_linkThe status of a link check. The specific value depends on the selected operation mode. $secure_link_expires The lifetime of a link passed in a request; intended to be used only in the secure_link_md5 directive. 
